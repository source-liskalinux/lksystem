...
#define VERSION "$Id: 7ec46aa84fc50610b74c7a186fb265186aa9a3df $"
...
void fatal(char *m) {
  strerr_die5sys(111, "lksys ", dir, ": fatal: ", m, ": ");
}
void fatal2(char *m1, char *m2) {
  strerr_die6sys(111, "lksys ", dir, ": fatal: ", m1, m2, ": ");
}
void fatalx(char *m1, char *m2) {
  strerr_die5x(111, "lksys ", dir, ": fatal: ", m1, m2);
}
void warn(char *m) {
  strerr_warn5("lksys ", dir, ": warning: ", m, ": ", &strerr_sys);
}
void warn2(char *m1, char *m2) {
  strerr_warn6("lksys ", dir, ": warning: ", m1, m2, ": ", &strerr_sys);
}
void warnx(char *m1, char *m2, char *m3) {
  strerr_warn6("lksys ", dir, ": warning: ", m1, m2, m3, 0);
}
...
#ifndef lksys_STATUS_BINARYONLY
  char bspace[64];
  buffer b;
