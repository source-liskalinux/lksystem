...
#define USAGE " 0|6"
#define FATAL "lksystem-init: fatal: "
/* #define WARNING "lksystem-init: warning: " */
...
int main (int argc, const char * const *argv, char * const *envp) {
  ...
  if (getpid() == 1) {
    ...
    /* kernel is starting init, lksystem does the job. */
    execve(LKSYSTEM, (char *const *)prog, envp);
